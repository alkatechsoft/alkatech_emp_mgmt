                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="p_address" class="form-control" name="p_address" id="p_address" oninput="field_validation('Address','p_address','error_p_address')" placeholder="Permanent address" />
