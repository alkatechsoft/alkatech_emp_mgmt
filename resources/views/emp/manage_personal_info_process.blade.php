                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="p_address" class="form-control" name="p_address" id="p_address" oninput="address_validation('this','p_address','error_p_address')" placeholder="Permanent address" />
                    ...
                    <div class="col-xl-4">
                        ...
                        <input type="text" name="p_city" class="form-control" id="p_city" oninput="field_validation('city','p_city','error_p_city')" placeholder="City">
                    ...
                    <div class="col-xl-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="p_state" class="form-control" id="p_state" oninput="field_validation('state','p_state','error_p_state')" placeholder="State">
                    ...
                    <div class="col-xl-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="p_pincode" class="form-control" id="p_pincode" oninput="pincode_validation('pincode','p_pincode','error_p_pincode')" placeholder="Pincode">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="form-group">
                                  ...
                                  <input type="textarea" name="c_address" class="form-control" id="c_address" oninput="address_validation('this','c_address','error_c_address')" placeholder="Current address">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="c_city" class="form-control" id="c_city" oninput="field_validation('city','c_city','error_c_city')" placeholder="City">
                            ...
                            <div class="col-xl-4">
                              <div class="form-group">
                                ...
                                <input type="text" name="c_state" class="form-control" id="c_state" oninput="field_validation('city','c_state','error_c_state')" placeholder="State">
                            ...
                            <div class="col-xl-4">
                              <div class="form-group">
                                ...
                                <input type="text" name="c_pincode" class="form-control" id="c_pincode" oninput="pincode_validation('pincode','c_pincode','error_c_pincode')" placeholder="Pincode">
